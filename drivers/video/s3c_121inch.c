...
#define H_FP		180		/* front porch */
#define H_SW		18		/* Hsync width */
#define H_BP		40		/* Back porch */

#define V_FP		10		/* front porch */
#define V_SW		8		/* Vsync width */
#define V_BP		20		/* Back porch */
...
#define VFRAME_FREQ     25	/* frame rate freq */
#define PIXEL_BPP8	8
