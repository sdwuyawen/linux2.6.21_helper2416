...
#define V_RESOLUTION	600	/* line cnt       y resolution */
...
struct s3c_fb_mach_info mach_info = {
	...
	.wincon1=  S3C_WINCONx_HAWSWP_ENABLE | S3C_WINCONx_BURSTLEN_16WORD |  S3C_WINCONx_BPPMODE_F_16BPP_565 | S3C_WINCONx_BLD_PIX_PLANE | S3C_WINCONx_ALPHA_SEL_1,  // 4word burst, 16bpp for OSD
	//.wincon1=  S3C_WINCONx_HAWSWP_ENABLE | S3C_WINCONx_BURSTLEN_4WORD |  S3C_WINCONx_BPPMODE_F_16BPP_A555 | S3C_WINCONx_BLD_PIX_PIXEL| S3C_WINCONx_ALPHA_SEL_1,  // 4word burst, 16bpp for OSD
	#elif defined(CONFIG_CPU_S3C6400) || defined(CONFIG_CPU_S3C6410)
...
void Init_LDI(void)
{
	printk(KERN_INFO "LCD TYPE :: S3C_8inch LCD will be initialized\n");
