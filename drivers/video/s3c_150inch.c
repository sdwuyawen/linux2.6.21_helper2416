...
// QCIF OSD image
#define H_RESOLUTION_OSD	1024	/* horizon pixel  x resolition */
#define V_RESOLUTION_OSD	768	/* line cnt       y resolution */
...
#define H_RESOLUTION	1024	/* horizon pixel  x resolition */
#define V_RESOLUTION	768	/* line cnt       y resolution */

#define H_RESOLUTION_VIRTUAL	1024	/* horizon pixel  x resolition */
#define V_RESOLUTION_VIRTUAL	768	/* line cnt       y resolution */

#define VFRAME_FREQ     40	/* frame rate freq */
#define PIXEL_BPP8	8
...
void Init_LDI(void)
{
	printk(KERN_INFO "LCD TYPE :: S3C_12.1inch LCD will be initialized\n");
