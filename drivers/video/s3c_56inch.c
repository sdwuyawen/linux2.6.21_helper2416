...
#define H_FP		210		/* front porch */
#define H_SW		20		/* Hsync width */
#define H_BP		46		/* Back porch */

#define V_FP		12		/* front porch */
#define V_SW		10		/* Vsync width */
#define V_BP		23		/* Back porch */
...
#define V_RESOLUTION_OSD	600	/* line cnt       y resolution */
...
#define H_RESOLUTION	640	/* horizon pixel  x resolition */
#define V_RESOLUTION	480	/* line cnt       y resolution */

#define H_RESOLUTION_VIRTUAL	800	/* horizon pixel  x resolition */
#define V_RESOLUTION_VIRTUAL	525	/* line cnt       y resolution */
...
struct s3c_fb_mach_info mach_info = {
	...
	.vidcon1= S3C_VIDCON1_IHSYNC_INVERT | S3C_VIDCON1_IVSYNC_INVERT | S3C_VIDCON1_IVCLK_RISE_EDGE ,
	...
	.wincon0=  S3C_WINCONx_HAWSWP_ENABLE | S3C_WINCONx_BURSTLEN_16WORD | S3C_WINCONx_BPPMODE_F_16BPP_565,
	//.wincon1=  S3C_WINCONx_HAWSWP_ENABLE | S3C_WINCONx_BURSTLEN_4WORD |  S3C_WINCONx_BPPMODE_F_16BPP_565 | S3C_WINCONx_BLD_PIX_PLANE | S3C_WINCONx_ALPHA_SEL_1,  // 4word burst, 16bpp for OSD
	.wincon1=  S3C_WINCONx_HAWSWP_DISABLE | S3C_WINCONx_BURSTLEN_16WORD |  S3C_WINCONx_BPPMODE_F_16BPP_565 | S3C_WINCONx_BLD_PIX_PLANE | S3C_WINCONx_ALPHA_SEL_1,  // 4word burst, 16bpp for OSD
				   ...
				   struct fb_var_screeninfo *var)
{
	...
	case 16:
		...
		mach_info.wincon1=  S3C_WINCONx_BYTSWP_ENABLE | S3C_WINCONx_BURSTLEN_8WORD |  S3C_WINCONx_BPPMODE_F_16BPP_565 | S3C_WINCONx_BLD_PIX_PLANE | S3C_WINCONx_ALPHA_SEL_1;  //
		#if defined(CONFIG_CPU_S3C6400) || defined(CONFIG_CPU_S3C6410)
...
#if 0		// YX_MODI by cc for setting GPC0 to output to set s1d13521 CNF2 to 1
	__raw_writel(0xaaaa02aa, S3C2410_GPCCON);  // CTRL,  VD[7:0]
#else
	__raw_writel(0xaaaa02a9, S3C2410_GPCCON);  // CTRL,  VD[7:0]
#endif
...
// YX_MODI for WIFI_AUDIO Power contron begin
#if 0
	/* LCD Backlight ON */
...
#else
#endif
// YX_MODI for WIFI_AUDIO Power contron end
...
void Init_LDI(void)
{
	printk(KERN_INFO "LCD TYPE :: S3C_56.1inch LCD will be initialized\n");
