...
typedef struct s3c_pwm_chan_s s3c2443_pwm_chan_t;
...
extern s3c2443_pwm_chan_t s3c_chans[];
...
extern int s3c2443_pwm_request(pwmch_t channel, s3c_pwm_client_t *, void *dev);
...
extern int s3c2443_pwm_free(pwmch_t channel, s3c_pwm_client_t *);
...
extern int s3c2443_pwm_set_buffdone_fn(pwmch_t, s3c_pwm_cbfn_t rtn);

extern int s3c2443_timer_setup (int channel, int usec, unsigned long g_tcnt, unsigned long g_tcmp);
