...
typedef struct s3c_pwm_chan_s s3c2450_pwm_chan_t;
...
extern s3c2450_pwm_chan_t s3c_chans[];
...
extern int s3c2450_pwm_request(pwmch_t channel, s3c_pwm_client_t *, void *dev);
...
extern int s3c2450_pwm_free(pwmch_t channel, s3c_pwm_client_t *);

extern int s3c2450_pwm_set_buffdone_fn(pwmch_t, s3c_pwm_cbfn_t rtn);
