...
#define __ASM_ARCH_REGS_GPIO_H "$Id: regs-gpio.h,v 1.13 2008/05/29 10:24:49 boyko Exp $"
...
#define S3C2410_GPH11         S3C2410_GPIONO(S3C2410_GPIO_BANKH, 11)
#define S3C2410_GPH11_INP     (0x00 << 22)
#define S3C2410_GPH11_OUTP    (0x01 << 22)
#define S3C2410_GPH11_nRTS    (0x02 << 22)

#define S3C2410_GPH12         S3C2410_GPIONO(S3C2410_GPIO_BANKH, 10)
#define S3C2410_GPH12_INP     (0x00 << 24)
#define S3C2410_GPH12_OUTP    (0x01 << 24)
#define S3C2410_GPH12_EXTUART (0x02 << 24)
...
/* Port K consists of11 GPIO/SDATA/ pins
 *
 * GPGCON has 2 bits for each of the input pins on port F
 *   00 = 0 input, 1 output, 2 sdata (SDATA16..31), 3 special func
 *
 * pull up works like all other ports.
*/

#define S3C2410_GPKCON	   S3C2410_GPIOREG(0xE0)
#define S3C2410_GPKDAT	   S3C2410_GPIOREG(0xE4)
#define S3C2410_GPKUP	   S3C2410_GPIOREG(0xE8)
...
#define S3C2410_GPK12         S3C2410_GPIONO(S3C2410_GPIO_BANKK, 10)
...
#define S3C2416_GPK14         S3C2410_GPIONO(S3C2410_GPIO_BANKK, 14)
#define S3C2416_GPK14_INP     (0x00 << 28)
#define S3C2416_GPK14_OUTP    (0x01 << 28)

#define S3C2416_GPK15         S3C2410_GPIONO(S3C2410_GPIO_BANKK, 15)
#define S3C2416_GPK15_INP     (0x00 << 30)
#define S3C2416_GPK15_OUTP    (0x01 << 30)
...
/* definitions for power domain SDRAM and SRAM */
#define S3C2450_PDDMCON		S3C2410_GPIOREG(0x114)
#define S3C2450_PDSMCON		S3C2410_GPIOREG(0x118)
